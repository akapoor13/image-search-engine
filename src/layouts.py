        ...
        dbc.Modal(
            [
                dbc.ModalBody([
                    ...
                    html.Div([
                        html.Div([
                            search_description(const.SEARCHDESCID_),
                            input_picture(const.SEARCHUPLOADID_),
                            search_description(const.SEARCHPICID_,
            ...
            [
                html.Div([
                    dash_table.DataTable(
                        id='results_table',
                        columns=[{
                            'name': ['Results'] + [const.COLMAPPING_[i]],
                            'id': i
                        } 
                            # if i != const.SIMILARCOL_ \
                        #     else {
                        #     'name': ['Results'] + [const.COLMAPPING_[i]],
                        #     'id': i,
                        #     'type': 'numeric',
                ...
                html.Div(
                    [
                        ...
                        html.Div([
                            html.Div(html.Img(id='selected_image',
                                              style={
                                                  'width': '100%',
                                                  'padding': '15px'
                                              }),
                                     style={'width': '25%'}),
                            html.Div([
                                html.Details([picture_input('edit')],
                                             style={'padding': '10px'},
                                             open=True)
                            ],
                                     style={'width': '100%'})
